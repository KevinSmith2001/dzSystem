...
<div style="margin-top: 10px;min-height: 770px">
    <div style="width:97%;margin: 0 auto;height:550px;border:1px solid #c4c7ca;background-color: #ffffff;overflow: scroll;padding: 10px 20px">
        <p style="text-align: center;margin-top: 5px;font-size: 16px;color: #635f5f;"><strong>报名须知</strong></p>
        <p style="text-align: center;margin-top: 5px;font-size: 16px;color: #635f5f;">这里是时间</p>
        <!--font-weight: bold;-->
        <div style="margin: 0px auto">
            <p>报名须知报名须知报名须知报名须知报名须知</p>
        </div>
    </div>
</div>
<!--底部-->
